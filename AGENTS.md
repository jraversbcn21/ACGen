...
**Total: 469 tests across 46 files.**
...
| `src/i18n/es.json` | 245 Spanish UI strings |
| `src/i18n/en.json` | 245 English UI strings — key set kept in exact parity with `es.json`, guarded by `src/i18n/keyParity.test.ts` |
