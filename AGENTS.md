...
| `src/components/SprintList.test.tsx` | 3 — start date rendered without UTC shift, dates formatted per app language, new-sprint form defaults to the LOCAL day (not the UTC day) |
| `src/App.test.tsx` | 1 — navigating between views scrolls to top |

**Total: 375 tests across 40 files.**
