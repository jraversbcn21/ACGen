...
export const Icon = {
  ...
  docs: (p: SvgProps) => (
    <Svg {...p}>
      <path d="M12 6.5C10.5 5 8.5 4.5 6 4.5c-1 0-2 .1-3 .4v13.6c1-.3 2-.4 3-.4 2.5 0 4.5.5 6 1.9 1.5-1.4 3.5-1.9 6-1.9 1 0 2 .1 3 .4V4.9c-1-.3-2-.4-3-.4-2.5 0-4.5.5-6 2z" />
      <path d="M12 6.5V20" />
    </Svg>
  ),
};
