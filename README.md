...
- **Portada tipo consola**: buscador con **Ctrl+K** (filtra las 11 herramientas por titulo y descripcion, sin acentos; Enter abre si queda una), chips por familia con recuento, y una tira de estado (Proveedor · Modelo · API Key) que pliega la configuracion tras el boton Editar.
...
| Tests | Vitest + React Testing Library (702 tests / 66 files) + 5 browser-checks con Playwright (38 asertos contra el build de produccion) |
| PWA | vite-plugin-pwa |
